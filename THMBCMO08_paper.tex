...
A sample state notation language graph is shown in Figure \ref{fig:simple.st},
and a sample record relationship graph is shown in Figure \ref{fig:records}.

\begin{figure}
   \centering
   \includegraphics*[width=.7\columnwidth]{st-simple}
   \caption{Simple state notation language program}
   \label{fig:simple.st}
\end{figure}
...
\begin{figure}
   ...
   \caption{Record relationship graph}
   \label{fig:records}
\end{figure}
...
Sample screenshots of the frontend are shown in Figures
\ref{fig:whatrecord-asg} and \ref{fig:whatrecord-links}.

\begin{figure}
   \centering
   \includegraphics*[width=.9\columnwidth]{whatrecord-asg}
   \caption{whatrecord frontend: record with access security group settings}
...
\begin{figure}
   ...
   \caption{whatrecord frontend: record with links}
